// Make sure you change the explosion type to the appropriate munition.
// When copying the script, do not copy the comments
//
// --- COMMON MUNITIONS ---
// Sh_155mm_AMOS
// Sh_82mm_AMOS
